  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="Contact Puramente Jewel, Jewelry Support, Puramente Jewel Contact, Jewelry Inquiries Europe																									"
        />
      ...
      <div>
        ...
        <div className="w-full items-center gap-10 lg:gap-0 flex flex-col lg:flex-row h-screen">
          ...
          <div className="lg:w-1/2 flex items-center flex-col">
            <h1 className="text-3xl text-black font-bold">Visit Our Store</h1>
