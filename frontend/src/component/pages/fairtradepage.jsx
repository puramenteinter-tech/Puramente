  ...
  return (
    <div>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Puramente Jewel International – fair trade jewelry manufacturer & wholesaler. Ethical & sustainable designs shipped to France, UK, USA & Europe."
        />
        <meta
          name="keywords"
          content="Fair Trade Jewelry, Jewelry Manufacturer, Ethical Jewelry, Sustainable Jewelry Europe"
        />
        <link rel="canonical" href="https://puramentejewel.com/fairtrade" />
      </Helmet>

      <h1  className="text-center text-4xl font-bold text-gray-800 mt-8 mb-6 capitalize">Fair Trade Jewelry by Puramente Jewel</h1>
